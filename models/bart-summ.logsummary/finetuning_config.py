...
models = OrderedDict([
    ...
    ("Large", ("facebook", "bart-large", {**base_config, **{"forced_bos_token_id": 0, "length_penalty": 1.5}})),
    ("CNN/DailyMail", ("facebook", "bart-large-cnn", {**base_config, **{"forced_bos_token_id": 0, "length_penalty": 1.0}})),
    ("XSum", ("facebook", "bart-large-xsum", {**base_config, **{"length_penalty": 1.4}})),
])
