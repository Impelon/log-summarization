...
models = OrderedDict([
    ...
    ("Large", ("facebook", "bart-large", {**base_config, **{"forced_bos_token_id": 0, "length_penalty": 1.22}})),
    ("CNN/DailyMail", ("facebook", "bart-large-cnn", {**base_config, **{"forced_bos_token_id": 0, "length_penalty": 1.2}})),
    ("XSum", ("facebook", "bart-large-xsum", {**base_config, **{"length_penalty": 1.75}})),
])
